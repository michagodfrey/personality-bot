...
'Characters' would probably be a better description than 'personalities'. This app is a chatbot, execpt the user selects a personality to personalize the responses.
...
Vercel serverless function (Node.js). Uses OpenAI `gpt-4o-mini` model. The server folder in this project is from an earlier version of the app that used the Railway hosting platform. It has been kept for developer reference and not used in the current project. 
